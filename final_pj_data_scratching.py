...
for i in range(len(major_link_a_list)):
	...
	for class_element in class_list_1:
		if len(class_element.xpath('strong'))>0:
			class_number = class_element.xpath('strong')[0].text_content().replace('.','')
		...
		try:
			...
			class_of_the_subject['Class_name'] = page.xpath('/html/body/div[2]/div[2]/div[2]/div[1]/h2/a[2]')[0].text_content()
			class_of_the_subject['Instructor'] = page.xpath('/html/body/div[2]/div[2]/div[2]/div[2]/div/div[2]/text()')[0]
			class_of_the_subject['Capacity'] = page.xpath('/html/body/div[2]/div[2]/div[2]/div[2]/div/div[5]')[0].text_content()
			class_of_the_subject['Day_And_Time'] = page.xpath('/html/body/div[2]/div[2]/div[2]/div[2]/div/div[4]/text()')[0]
			class_of_the_subject['Class_Location'] = page.xpath('/html/body/div[2]/div[2]/div[2]/div[2]/div/div[3]/text()')[0]
			all_data.append(class_of_the_subject)
			count = count+1
			print count
			# print class_of_the_subject
		except:
